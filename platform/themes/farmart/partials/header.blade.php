...
<body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl"
      @endif @if (Theme::get('bodyClass')) class="{{ Theme::get('bodyClass') }}" @endif>
...
{{--                            </ellipse>--}}
{{--                        </svg>--}}
{{--                        <img id="LOGO-LOGO" src="{{ RvMedia::getImageUrl(theme_option('logo')) }}"--}}
...
{{--                <img src="{{ Theme::asset()->url('images/mide.png') }}" alt="logo" class="logo-default"/>--}}
...
{{--                            <rect id="Rectangle_87" rx="12" ry="12" x="0" y="0" width="358" height="95">--}}
{{--                            </rect>--}}
{{--                        </svg>--}}
{{--                    </div>--}}
{{--                    <div id="Thc_n_qun">--}}
...
{{--                <div id="Group_137">--}}
{{--                    <div id="Group_132_bh">--}}
{{--                        <svg class="Rectangle_87_bi">--}}
{{--                            <rect id="Rectangle_87_bi" rx="12" ry="12" x="0" y="0" width="359" height="95">--}}
{{--                            </rect>--}}
{{--                        </svg>--}}
{{--                    </div>--}}
{{--                    <div id="t_n_hng_ln_gim_n_10">--}}
{{--                        <span>Đắt đơn hàng lớn</span><br><span style="font-size:40px;">(giãm đến 10%)</span>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
